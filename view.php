    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          ...
          <button type="button" class="btn btn-primary mb-4" data-toggle="modal" data-target="#addDetail">
            Tambah Detail Order
          </button>


          <!-- <a href="view.php?ido=<?= $idorder; ?>" class="btn btn-primary">Tampilkan</a> -->
          <a href="print.php?ido=<?= $ido; ?>" class="btn btn-info mb-4" target="_blank"><i class="fa fa-print"></i></a>
      ...
      <form method="post">
        ...
        <div class="modal-body">
          ...
          <select name="idproduct" class="form-control">
            ...
            <?php
            $get = mysqli_query($conn, "SELECT * FROM product WHERE idproduct NOT IN (SELECT idproduct FROM detailorder WHERE idorder='$ido')");
