                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Ubah Product</h5>
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            <input type="text" name="namaproduk" class="form-control" placeholder="Nama Produk" value="<?= $np; ?>">
                                                            <input type="text" name="deskripsi" class="form-control mt-2" placeholder="Deskripsi" value="<?= $desc; ?>">
                                                            <input type="number" name="stock" class="form-control  mt-2" placeholder="Stock Awal" disabled required min="1" value="<?= $stock; ?>">
                                                            <input type="number" name="harga" class="form-control mt-2" placeholder="Harga Produk" required min="1" value="<?= $price; ?>">
                                                            <input type="hidden" name="idproduk" value="<?= $idp; ?>">
                                                        </div>

                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-success" name="ubahbarang">Submit</button>
                                                        </div>
...
<div class="modal fade" id="addProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Tambah Product Baru</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <input type="number" name="stock" class="form-control  mt-2" placeholder="Stock Awal" required min="1">
                    <input type="number" name="harga" class="form-control mt-2" placeholder="Harga Produk" required min="1">
                </div>
