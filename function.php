...
if (isset($_POST['hapuscustomer'])) {
  ...
  $query = mysqli_query($conn, "DELETE FROM customer WHERE idcustomer='$idcust'");
...
if (isset($_POST['hapusbarangmasuk'])) {
  ...
  $query2 = mysqli_query($conn, "DELETE FROM incominggoods WHERE idinc='$idinc'");
...
if (isset($_POST['hapusorder'])) {
  ...
  $query3 = mysqli_query($conn, "DELETE FROM orders WHERE idorder='$ido'");
